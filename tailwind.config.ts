  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        jet: '#272726',        // Cinza escuro - elementos secundários
        tangerine: '#D45E0A',  // LARANJA PRINCIPAL - CTAs, destaques, ícones
        viridian: '#664869',   // Roxo/Vinho - gradientes e detalhes
        platinum: '#E9E5DE',   // Bege claro - backgrounds secundários
